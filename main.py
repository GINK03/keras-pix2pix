...
def main():
  ...
  parser.add_argument('--n_batch_per_epoch', default=1000, type=int, help="Number of training epochs")
  parser.add_argument('--nb_epoch', default=1000, type=int, help="Number of batches per epoch")
